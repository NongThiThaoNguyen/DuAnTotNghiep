...
namespace DuAnTotNghiep.Data.Migrations
{
    ...
    [Migration("20260903145538_AddClassroomEnrollmentTables")]
    partial class AddClassroomEnrollmentTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.AiGeneratedContent", b =>
                {
                    ...
                    b.Property<int?>("PublishedQuestionId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.AiUsageLog", b =>
                {
                    ...
                    b.Property<string>("ResponseOutput")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.CompetencyAnalysis", b =>
                {
                    ...
                    b.Property<string>("KnowledgeGapsJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("MetadataJson")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PrioritizedTopicsJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.ReferenceSource", b =>
                {
                    ...
                    b.Property<string>("ComplianceEvidenceUrl")
                        .HasMaxLength(1000)
                        .IsUnicode(false)
                        .HasColumnType("varchar(1000)")
                    ...
                    b.HasIndex(new[] { "SourceName" }, "IX_reference_sources_source_name");

                    b.HasIndex(new[] { "SourceUrl" }, "IX_reference_sources_source_url");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.ReplanningRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SuggestionExpiryDays")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.StudentLearningPath", b =>
                {
                    ...
                    b.Property<int>("PathVersion")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(1)
                        .HasColumnName("path_version");

                    b.Property<int?>("ReplacedByPathId")
                        .HasColumnType("int")
                        .HasColumnName("replaced_by_path_id");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.LearningPathNode", b =>
                {
                    ...
                    b.HasOne("DuAnTotNghiep.Models.LearningPathNode", "RequiredNode")
                        .WithMany("InverseRequiredNode")
                        .HasForeignKey("RequiredNodeId")
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.ReferenceSource", b =>
                {
                    ...
                    b.HasOne("DuAnTotNghiep.Models.User", "RejectedByNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.StudentLearningPath", b =>
                {
                    ...
                    b.HasOne("DuAnTotNghiep.Models.StudentLearningPath", "ReplacedByPath")
                        .WithMany("InverseReplacedByPath")
                        .HasForeignKey("ReplacedByPathId")
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.LearningPathNode", b =>
                {
                    ...
                    b.Navigation("InverseRequiredNode");
            ...
            modelBuilder.Entity("DuAnTotNghiep.Models.StudentLearningPath", b =>
                {
                    ...
                    b.Navigation("InverseReplacedByPath");
