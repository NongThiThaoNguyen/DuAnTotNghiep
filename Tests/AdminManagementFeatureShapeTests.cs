...
public class AdminManagementFeatureShapeTests
{
    ...
    [
        ...
        "TeacherAssignmentAdminController",
    ...
    private static readonly Dictionary<string, string[]> RequiredActions = new()
    {
        ...
        ["TeacherAssignmentAdminController"] = ["Index", "Create", "Assign", "Unassign"],
    ...
    [
        ...
        "TeacherAssignmentAdmin/Index.cshtml",
        "TeacherAssignmentAdmin/Create.cshtml",
